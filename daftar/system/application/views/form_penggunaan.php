<?php echo $this->load->view('top'); ?>
  ...
  <!-- formee-->
	<form class="formee" method="post" action="<?php echo base_url();?>index.php/main/prosess_form_penggunaan" >
	...
	<fieldset>
        ...
        <div class="grid-6-12">
				...
				<select class="" name="jenis_penggunaan" id="jenis_penggunaan">
                    ...
                    <option value="<?php echo $row->id_jenis_penggunaan; ?>"><?php echo $row->jenis_penggunaan; ?></option>
                    <?php endforeach; ?>                     
                </select>
        ...
        <div class="grid-12-12">
               ...
               <input type="text" name="jumlah_penggunaan" id="jumlah_penggunaan" value="" />
        </div>
        <div class="grid-12-12">
        ...
        <div class="grid-12-12">
			<input class="right" type="hidden" name="id_transaksi" id="id_transaksi" value="<?php echo $id_transaksi; ?>" />
